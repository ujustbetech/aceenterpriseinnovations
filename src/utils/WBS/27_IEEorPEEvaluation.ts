export function get27_IEEorPEEvaluation(WBSClick_count, WBSName, countR, column_no_start, estimate, department){
    const WBSElementArray = [
        //A,  B   ,  C , D ,                                                                        E , F                                ,G ,               H , I ,   J,  K ,  L   
        ["", "WBS",  "", 'IEE / PE Evaluation',                                                     "",''                                ,""             ,  "",  "",  "",  "", '',''],//0(R+1)
        ["", "S",    "", 'IEE / PE Evaluation',                                                     "",''                                ,""             ,  "",  "",  "",  "", '',''],//1(R+2)
        ["", "Y",    "", '="Prepare "&D'+(countR+1),                                                "",'=ROUND(L'+(countR+3)+'/(E1*8),1)',""             ,  "",  "",  "",  "", '24',''],//2(R+3)
        ["", "Y",    "", '="Review "&D'+(countR+1),                                                 "",'=ROUND(L'+(countR+4)+'/(E1*8),1)','=A'+(countR+3),  "",  "",  "",  "", '=ROUNDUP(SUM(L'+(countR+3)+')*0.15,0)',''],//3(R+4)
        ["", "Y",    "", 'Incorporate Internal Comments',                                           "",'=ROUND(L'+(countR+5)+'/(E1*8),1)','=A'+(countR+4),  "",  "",  "",  "", '=ROUNDUP(SUM(L'+(countR+3)+')*0.1,0)',''],//4(R+5)
        ["", "Y",    "", '="Submit Draft "&D'+(countR+1),                                           "",'1'                               ,'=A'+(countR+5),  "",  "",  "",  "", '1',''],//5(R+6)
        ["", "Y",    "", 'Multi-Discipline Review PE Evaluation (if required)',' include 2h to attend 30min call and disposition comments','10','=A'+(countR+6), "",  "",  "",  "", '2',''],//6(R+7)
        ["", "Y",    "", '="Update "&D'+(countR+1)+'&" (if required)"',                             "",'=ROUND(L'+(countR+8)+'/(E1*8),1)','=A'+(countR+7),  "",  "",  "",  "", '=ROUNDUP(SUM(L'+(countR+3)+':L'+(countR+7)+')*0.15,0)',''],//7(R+8)
        ["", "Y",    "", 'Approve PE Evaluation',                                                   "",'1'                               ,'=A'+(countR+8),  "",  "",  "",  "", '1',''],//8(R+9)
        ["", "Y",    "", '="Submit Final "&D'+(countR+1),                                           "",'1'                               ,'=A'+(countR+9),  "",  "",  "",  "", '1',''],//9(R+10)
        ["", "Y",    "", '="Client Accept "&D'+(countR+1),                                          "",'5'                               ,'=A'+(countR+10), "",  "",  "",  "", '0',''],//10(R+11)
    ]
