export function get24_IUC(WBSClick_count, WBSName, countR, column_no_start, estimate, department){
    const WBSElementArray = [
        //A,  B   ,  C , D ,                                                                        E , F ,G , H , I , J,  K , L   
        ["", "WBS",  "", 'Instrument Uncertainty Calculation (IUC)',                                "",''                                ,""             , "",  "",  "",  "", '',''],//0(R+1)
        ["", "S",    "", '="50% "&D'+(countR+1),                                                    "",''                                ,""             , "",  "",  "",  "", '',''],//1(R+2)
        ["", "Y",    "", 'Task Pre-Job Brief',                                                      "",'1'                               ,""             , "",  "",  "",  "", '2',''],//2(R+3)
        ["", "Y",    "", 'Create IUC',                                                              "",'=ROUND(L'+(countR+4)+'/(E1*8),1)','=A'+(countR+3), "",  "",  "",  "", '8',''],//3(R+4)
        ["", "Y",    "", 'Prepare IUC Memo',                                                        "",'=ROUND(L'+(countR+5)+'/(E1*8),1)','=A'+(countR+4), "",  "",  "",  "", '16',''],//4(R+5)
        ["", "Y",    "", 'Review IUC Memo',                                                         "",'=ROUND(L'+(countR+6)+'/(E1*8),1)','=A'+(countR+5), "",  "",  "",  "", '=ROUNDUP(SUM(L'+(countR+3)+':L'+(countR+5)+')*0.15,0)',''],//5(R+6)
        ["", "Y",    "", 'Incorporate Internal Comments',                                           "",'=ROUND(L'+(countR+7)+'/(E1*8),1)','=A'+(countR+6), "",  "",  "",  "", '=ROUNDUP(SUM(L'+(countR+3)+':L'+(countR+5)+')*0.1,0)',''],//6(R+7)
        ["", "Y",    "", 'Approve 50% IUC Memo',                                                    "",'1'                               ,'=A'+(countR+7), "",  "",  "",  "", '1',''],//7(R+8)
        ["", "Y",    "", 'Submit IUC Memo for Client Review',                                       "",'1'                               ,'=A'+(countR+8), "",  "",  "",  "", '1',''],//8(R+9)
        ["", "S",    "", '=D'+(countR+1)+'&" Comment & Disposition"',                               "",''                                ,""             , "",  "",  "",  "", '',''],//9(R+10)
        ["", "Y",    "", 'Client Stakeholder Review of IUC Memo',                                   "",'10'                              ,'=A'+(countR+9), "",  "",  "",  "", '0',''],//10(R+11)
        ["", "Y",    "", 'Disposition Stakeholder Comments',                                        "",'=ROUND(L'+(countR+12)+'/(E1*8),1)','=A'+(countR+11),"", "",  "",  "", '=ROUNDUP(SUM(L'+(countR+3)+':L'+(countR+9)+')*0.1,0)',''],//11(R+12)
        ["", "Y",    "", 'Client Accept Comment Dispositions',                                      "",'5'                               ,'=A'+(countR+12),"",  "",  "",  "", '1',''],//12(R+13)
        ...
        ["", "Y",    "", 'Final Verification of 90% IUC Memo',                                      "",'=ROUND(L'+(countR+16)+'/(E1*8),1)','=A'+(countR+15),"", "",  "",  "", '=L'+(countR+15)+'/2',''],//15(R+16)
        ["", "Y",    "", 'Approve 90% IUC Memo',                                                    "",'1'                              ,'=A'+(countR+16), "",  "",  "",  "", '1',''],//16(R+17)
        ["", "Y",    "", 'Submit IUC 90% Memo for Client Acceptance',                               "",'1'                              ,'=A'+(countR+17), "",  "",  "",  "", '1',''],//17(R+18)
        ["", "Y",    "", 'Client Accepts 100% IUC Memo',                                            "",'5'                              ,'=A'+(countR+18), "",  "",  "",  "", '0',''],//18(R+19)
