...
export function get10_TechnicalSpecification(WBSClick_count, WBSName, countR, column_no_start, estimate, department){
    const WBSElementArray = [
        //A,  B   ,  C , D ,                                                                        E ,                                   F ,              G ,  H , I ,   J,  K , L   
        ["", "WBS",  "", 'Technical Specification',                                                 "",''                                ,""             , "",  "",  "",  "", '',''],//0(R+1)
        ["", "S",    "", '="50% "&D'+(countR+1),                                                    "",''                                ,""             , "",  "",  "",  "", '',''],//1(R+2)
        ["", "Y",    "", 'Pre-Job Brief',                                                           "",'1'                               ,""             , "",  "",  "",  "", '2',''],//2(R+3)
        ["", "Y",    "", 'Gather&Review Documentation',                                             "",'=ROUND(L'+(countR+4)+'/(8*E1),1)','=A'+(countR+3), "",  "",  "",  "", '8',''],//3(R+4)
        ["", "Y",    "", '="Prepare 50% "&D'+(countR+1),                                            "",'=ROUND(L'+(countR+5)+'/(8*E1),1)','=A'+(countR+4), "",  "",  "",  "", '32',''],//4(R+5)
        ...
        ["", "Y",    "", 'Incorporate Accepted Comments',                                           "",'=ROUND(L'+(countR+15)+'/(8*E1),1)','=A'+(countR+13), "", "",  "",  "", '=ROUNDUP(L'+(countR+12)+'/2,0)',''],//14(R+15)
