export function get23_ReportorMemo(WBSClick_count, WBSName, countR, column_no_start, estimate, department){
    const WBSElementArray = [
        ...
        ["", "Y",    "", '="Prepare 50% "&D'+(countR+1),                                            "",'=ROUND(L'+(countR+5)+'/(E1*8),1)','=A'+(countR+4), "",  "",  "",  "", '32',''],//4(R+5)
        ...
        ["", "Y",    "", '="Submit "&D3&" for Client Review"',                                      "",'1'                               ,'=A'+(countR+8), "",  "",  "",  "", '1',''],//8(R+9)
        ["", "S",    "", '=D'+(countR+1)+'&" Comment & Disposition"',                               "",''                                ,""             , "",  "",  "",  "", '',''],//9(R+10)
        ["", "Y",    "", '="Client Stakeholder Review of "&D'+(countR+1),                           "",'10'                              ,'=A'+(countR+9), "",  "",  "",  "", '0',''],//10(R+11)
        ...
        ["", "Y",    "", '="Final Verification of 90% "&D'+(countR+1),                              "",'=ROUND(L'+(countR+16)+'/(E1*8),1)','=A'+(countR+15), "",  "",  "",  "", '=L'+(countR+15)+'/2',''],//15(R+16)
