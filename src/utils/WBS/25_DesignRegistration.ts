export function get25_DesignRegistration(WBSClick_count, WBSName, countR, column_no_start, estimate, department){
    const WBSElementArray = [
        //A,  B   ,  C , D ,                                                                        E , F ,G , H , I , J,  K , L   
        ["", "WBS",  "", 'Design Registration Package',                                             "",''                                ,"", "",  "",  "",  "", '',''],//0(R+1)
        ["", "S",    "", '="50% "&D'+(countR+1),                                                    "",''                                ,"", "",  "",  "",  "", '',''],//1(R+2)
        ["", "Y",    "", 'Prepare Cover Letter',                                                    "",'1'                               ,"", "",  "",  "",  "", '24',''],//2(R+3)
        ["", "Y",    "", 'Compile Package',                                                         "",'=ROUND(L'+(countR+4)+'/(E1*8),1)','=A'+(countR+3), "",  "",  "",  "", '16',''],//3(R+4)
        ...
        ["", "Y",    "", '="Submit 50% "&D'+(countR+1)+'&" for Client Review"',                     "",'1'                               ,'=A'+(countR+7), "",  "",  "",  "", '1',''],//7(R+8)
        ...
        ["", "Y",    "", '="Submit "&D'+(countR+1)+'&" to Client or the TSSA"',                     "",'1'                               ,'=A'+(countR+16), "",  "",  "",  "", '1',''],//16(R+17)
        ["", "Y",    "", 'PDE Mgr Review and Sign Cover Letter',     'If not sending directly to TSSA','5'                               ,'=A'+(countR+17), "",  "",  "",  "", '0',''],//17(R+18)
        ["", "Y",    "", 'Submit Package to TSSA Administrator',     'If not sending directly to TSSA','1'                               ,'=A'+(countR+18), "",  "",  "",  "", '1',''],//18(R+19)
        ["", "Y",    "", 'TSSA Review',                                                             "",'15'                              ,'=A'+(countR+19), "",  "",  "",  "", '0',''],//19(R+20)
        ["", "Y",    "", 'Provide clarifications to the TSSA as required',                          "",'15'                              ,'=A'+(countR+19), "",  "",  "",  "", '8',''],//20(R+21)
        ["", "Y",    "", '="TSSA Accepts "&D'+(countR+1),                                           "",'5'                               ,'=A'+(countR+20)+'&A'+(countR+21), "",  "",  "",  "", '0',''],//21(R+22)
