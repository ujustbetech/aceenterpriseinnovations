export function get20_SCLUpdate(WBSClick_count, WBSName, countR, column_no_start, estimate, department){
    const WBSElementArray = [
        //A,  B   ,  C , D ,                                                                        E , F                                ,G , H , I , J,  K , L   

        ["", "WBS",  "", 'SCL Update',                                                              "",''                                ,""             , "",  "",  "",  "", '',''],//0(R+1)
        ["", "S",    "", '="50% "&D'+(countR+1),                                                    "",''                                ,""             , "",  "",  "",  "", '',''],//1(R+2)
        ["", "Y",    "", 'Data Collection',                                                         "",'=ROUND(L'+(countR+3)+'/(E1*8),1)',""             , "",  "",  "",  "", '4',''],//2(R+3)
        ["", "Y",    "", '="Prepare "&D'+(countR+1),                                                "",'=ROUND(L'+(countR+4)+'/(E1*8),1)','=A'+(countR+3), "",  "",  "",  "", '16',''],//3(R+4)
        ["", "Y",    "", '="Review "&D'+(countR+1),                                                 "",'=ROUND(L'+(countR+5)+'/(E1*8),1)','=A'+(countR+4), "",  "",  "",  "", '=ROUNDUP(SUM(L'+(countR+3)+':L'+(countR+4)+')*0.15,0)',''],//4(R+5)
        ["", "Y",    "", 'Incorporate Internal Comments',                                           "",'=ROUND(L'+(countR+6)+'/(E1*8),1)','=A'+(countR+5), "",  "",  "",  "", '=ROUNDUP(SUM(L'+(countR+3)+':L'+(countR+4)+')*0.1,0)',''],//5(R+6)
        ["", "Y",    "", '="Approve "&D'+(countR+1),                                                "",'1'                               ,'=A'+(countR+6), "",  "",  "",  "", '1',''],//6(R+7)
        ["", "Y",    "", '="Submit "&D'+(countR+1)+'&" for Review"',                                "",'1'                               ,'=A'+(countR+7), "",  "",  "",  "", '1',''],//7(R+8)
        ["", "S",    "", 'Report: Comment & Disposition',                                           "",''                                ,""             , "",  "",  "",  "", '',''],//8(R+9)
        ...
        ["", "Y",    "", 'Client Accept Comment Dispositions',                                      "",'5'                               ,'=A'+(countR+11), "",  "",  "",  "", '0',''],//11(R+12)
        ...
        ["", "Y",    "", '="Client Accept 100% "&D'+(countR+1),                                     "",'5'                                ,'=A'+(countR+17), "",  "",  "",  "", '0',''],//17(R+18)
